...
public class RectangleTest {
	...
	public void testGetLength() {
		assertEquals(2.0, rect1.getLength(), 0.001);
		assertEquals(2.0, rect2.getLength(), 0.001);
	}
	...
	public void testGetWidth() {
		assertEquals(5.0, rect1.getWidth(), 0.001);
		assertEquals(3.0, rect2.getWidth(), 0.001);
	}
